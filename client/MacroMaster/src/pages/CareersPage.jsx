...
export default function CareersPage() {
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex flex-col items-center py-6 px-4">
      ...
      <div className="relative w-full max-w-6xl overflow-hidden py-3">
        <div className="flex animate-scroll gap-6">
          {positions.concat(positions).map((pos, idx) => (
            ...
            >
              <h3 className="text-xl md:text-2xl font-semibold mb-2 text-gray-900 dark:text-gray-100">{pos.title}</h3>
              <p className="text-gray-700 dark:text-gray-300 text-md md:text-lg leading-relaxed">{pos.description}</p>
            </div>
          ))}
        </div>
      </div>
