	...
	return (
		<div className="w-full max-w-7xl mx-auto px-6 md:px-12 py-12 md:py-16 space-y-14">
			<div className="text-center space-y-6">
				...
				<div className="mt-6 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/20 rounded-3xl shadow-inner text-center animate-fade-in max-w-3xl mx-auto">
					{loading && (
					...
					{!loading && !error && (
						<p className="italic text-xl text-blue-700 dark:text-blue-300 font-medium">
							“{quote.content}”
							{quote.author && (
